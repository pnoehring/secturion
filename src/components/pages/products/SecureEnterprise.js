...
import enterprise from '../../images/secure_enterprise.png';
import enterpriseMobile from '../../images/secure_enterprise-mobile.png';

function SecureEnterprise() {
  return (
    <div>
      <ContentPageHero
        header=''
