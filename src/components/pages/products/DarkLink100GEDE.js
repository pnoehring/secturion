    ...
    <div>
      ...
      <OneProductPage
        ...
        text={<span>The&nbsp;
          ...
          &trade;-100G EDE is
          an enterprise-level encryptor designed
          to meet DoD Ethernet Data Encryption
          (EDE) specifications.&nbsp;
          <span className='italic'>DarkLink</span>
          &trade;-100G EDE utilizes Secturion’s MESH
          technology to set up a safe, private
          network between multiple sites.</span>}
        label={<span>
          <span className='italic'>DarkLink</span>
          -100G EDE</span>}
        features={<span>
        ...
        linkText='Request DarkLink-100G EDE Brochure'
        easeOfUse={<span>
...
export default DarkLink100GEDE